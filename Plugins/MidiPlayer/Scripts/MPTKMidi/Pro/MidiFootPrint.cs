...
{
    /// <summary>
    /// Experimental - Pro version 2.89.0 - These capability and API could evolve in time or ... disappear!\n
    /// Search a MIDI from a sequence of notes and calculate a score tempo.\n
