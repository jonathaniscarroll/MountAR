...
namespace MidiPlayerTK
{
    public partial class MidiStreamPlayer : MidiSynth
    {
        ...
        ///! @li @c  0      minimum (equivalent to value 0 for midi standard event) 
        ///! @li @c  0.5    centered (equivalent to value 8192 for midi standard event) 
        ///! @li @c  1      maximum (equivalent to value 16383 for midi standard event)
        /// </param> 
