...
namespace MidiPlayerTK
{
    ...
    /// This class is deprecated. Used rather MidiFileWriter2.
    /// </summary>
    public class MidiFileWriter
    {
        ...
        public MidiFileWriter(int deltaTicksPerQuarterNote, int midiFileType)
        {
            try
            {
                Debug.LogWarning("The class MidiFileWriter is deprecatd and will be removed from the next major version. Use MidiFileWriter2 class.");
