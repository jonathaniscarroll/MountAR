    ...
    public class MidiListPlayerEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            try
            {
                ...
                commonEditor.DrawCaption("Midi List Player - Play from a list of Midi.", "https://paxstellar.fr/midi-list-player-v2/", "dd/d3d/class_midi_player_t_k_1_1_midi_list_player.html");
