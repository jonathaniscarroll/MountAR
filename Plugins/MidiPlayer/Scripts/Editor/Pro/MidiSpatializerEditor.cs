    ...
    public class MidiSpatializerEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            try
            {
                ...
                {
                    commonEditor.DrawCaption("Midi Spatializer Player - Play for a specific channel or track.", "https://paxstellar.fr/midi-file-player-detailed-view-2/", "db/d06/class_midi_player_t_k_1_1_midi_spatializer.html");

                    EditorGUILayout.LabelField($"Id Synth: {instance.MPTK_SpatialSynthIndex + 1}");
                    EditorGUILayout.LabelField($"Preset: {instance.MPTK_ChannelPresetGetName(instance.MPTK_SpatialSynthIndex)}");
                ...
                {
                    commonEditor.DrawCaption("Midi Spatializer Player - Play Midi and apply position for each instruments.", "https://paxstellar.fr/midi-file-player-detailed-view-2/", "db/d06/class_midi_player_t_k_1_1_midi_spatializer.html");
