    ...
    public class MidiInReaderEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            try
            {
                ...
                commonEditor.DrawCaption("Midi In Reader - Read Midi events from your Midi keyboard.", "https://paxstellar.fr/prefab-midiinreader/", "d0/d5e/class_midi_player_t_k_1_1_midi_in_reader.html");
