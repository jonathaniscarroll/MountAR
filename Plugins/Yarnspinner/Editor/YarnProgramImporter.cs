...
{
    [UnityEditor.AssetImporters.ScriptedImporter(1, new[] { "yarnprogram" }, 1), HelpURL("https://yarnspinner.dev/docs/unity/components/yarn-programs/")]
    public class YarnProgramImporter : UnityEditor.AssetImporters.ScriptedImporter
    {
    ...
    public class YarnProgramImporterEditor : UnityEditor.AssetImporters.ScriptedImporterEditor
    {
